...
export default function CountryDetails() {
    ...
    return (
      <div className={`min-h-screen ${isDark ? "bg-gray-900" : "bg-gray-100"} flex items-center justify-center`}>
        <div className="flex flex-col items-center gap-4">
          ...
          <p className={`text-lg ${isDark ? "text-gray-400" : "text-gray-600"}`}>Loading country details...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className={`min-h-screen ${isDark ? "bg-gray-900" : "bg-gray-100"} flex items-center justify-center p-6`}>
        <div className={`max-w-md w-full p-8 rounded-2xl shadow-xl text-center ${isDark ? "bg-gray-800" : "bg-white"}`}>
  ...
  return (
    <div className={`min-h-screen ${isDark ? "bg-gray-900" : "bg-gray-100"} p-6 animate-fade-in`}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="relative group">
            <div className="rounded-2xl overflow-hidden shadow-2xl transform transition-transform duration-500 group-hover:scale-105">
              <img
          ...
          <div className={`${isDark ? "text-white" : "text-gray-900"}`}>
            ...
            <p className="text-xl mb-8 italic text-gray-500">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              ...
              <div className={`p-4 rounded-xl ${isDark ? "bg-gray-800" : "bg-white"} shadow-lg hover:shadow-xl transition-shadow duration-300`}>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="font-semibold">Subregion</h3>
                </div>
